...
global $smcFunc, $db_prefix, $modSettings, $existing_tables, $boardurl, $db_name;
...
$smf_prefix = substr(strstr($db_prefix, $db_name), strlen($db_name));
$smf_prefix = trim(strstr($smf_prefix, '.'), '`.');
...
-webkit-box-shadow: 5px 5px 40px 0 rgba(0,0,0,0.6); box-shadow: 5px 5px 40px 0 rgba(0,0,0,0.6);  border-radius: 6px 6px 0 0;">
<div class="cat_bar"><h3 class="catbg">Install/Upgrade TinyPortal v2.0 for SMF 2.1.x<h3/></div>
