			...
			echo '
				<tr class="windowbg2">
					<td width="100" class="windowbg' , $alt ? '' : '2' , '">
						<a href="' . $scripturl . '?cat=' . $cat['id'] . '" title="' . $txt['tp-preview'] .'"><img src="' . $settings['tp_images_url'] . '/TPfilter.png" alt="" /></a>
						...
						<a href="' . $scripturl . '?action=tpadmin;sa=categories;cu='.$cat['id'].'" title="' . $txt['tp-editcategory']. '"><img src="' . $settings['tp_images_url'] . '/TPmodify.png" alt="" /></a>
					</td>
			...
			if(in_array($cat['parent'],$context['TPortal']['basecats']))
			{
				...
				foreach($context['TPortal']['cats'] as $d => $subcat)
				{
					if($subcat['parent']==$cat['id'])
					{
						echo '
				<tr class="windowbg2">
					<td width="80%" class="windowbg' , $alt ? '' : '2' , '">&nbsp;&nbsp;<img src="' . $settings['tp_images_url'] . '/TPtree_article.png" alt="" />
					...
					<td style="padding: 0; border: none;">
						<table class="formtable" id="editblock">
							...
							<tr class="windowbg2">
								...
								<td class="right"><img src="' . $settings['tp_images_url'] . '/TP' , $context['TPortal']['blockedit']['off']==0 ? 'green' : 'red' , '.png" alt="" />
