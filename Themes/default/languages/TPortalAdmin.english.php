...
$txt['tp-frontpagehelp'] = 'Frontpage is the first page a user will see of your portal. All settings for the frontpage determines how you want your user to see the first page of your portal Your frontpage can be different from the rest of your portal or forum.';
$txt['tp-frontpagedesc1'] = 'All of the settings here control everything about what appears on your frontpage.';
$txt['tp-panelhelp'] = 'This admin section of TinyPortal controls all your settings for your left, right, upper, lower, top, and bottom panels for your blocks, creation of all types of blocks, block settings, visual options for blocks, and activation of each one. This allows you to display images, scripts, or information in certain areas around your forum, in turn making it into a portal.';
...
$txt['tp-displayupperpanel'] = 'Display upper panel';
...
$txt['tp-frontpageoptions'] = 'Additional panels to display on frontpage: <br><span class="smalltext" style="color: #ff0000;">( Note: for frontpage only, this overrides any panel that has been turned on, but is also overridden by an article\'s "single page" option. )</span>';
...
$txt['tp-articleoptions10'] = 'Display topblocks';
$txt['tp-articleoptions11'] = 'Display lowerblocks';
...
$txt['tp-articleoptions6'] = 'Display upperblocks';
$txt['tp-articleoptions7'] = 'Display rightblocks';
$txt['tp-articleoptions8'] = 'Display leftblocks';
$txt['tp-articleoptions9'] = 'Display bottomblocks';
...
$txt['tp-editcategories'] = 'Edit Categories';
...
$txt['tp-newcategory'] = 'New category';
...
$txt['tp-illustration'] = 'Alternative listing icon (128x128 px)';
$txt['tp-nocat'] = '-no parent-';
$txt['tp-catlayouts'] = 'Layout types:';
$txt['tp-catlayout1'] = 'Normal article';
$txt['tp-catlayout2'] = 'Normal + icons';
$txt['tp-catlayout3'] = 'Icon + links';
$txt['tp-catlayout4'] = 'Icon + Article';
$txt['tp-catlayout5'] = 'Menu + Article';
$txt['tp-catlayout6'] = 'Just links';
$txt['tp-catlayout7'] = 'Use custom template';
$txt['tp-catlayout8'] = 'Icon + Article 2';
...
$txt['tp-addcategoryinfo'] = 'When you add a new category as a subcategory of another, the new will inherit access and options from its parent.
Note that you can easily change it on the single category editing screen. ';
$txt['tp-bbcarticle'] = 'BBC type of article';
$txt['tp-adminicons7'] = 'Icons to be used in category layouts';
$txt['tp-adminicons6'] = 'Upload a new icon:<br><span class="smalltext">(Max-size: 500KB. Images resized to 128x128 px.)</span>';
$txt['tp-adminicons5'] = 'Icons';
...
$txt['tp-submissionsettings2'] = 'Membergroup access:';
$txt['tp-submittedarticles'] = 'Submitted articles';
...
$txt['tp-showonfrontpage']='Display on front page:';
...
$txt['tp-editgrouphelp'] = 'Choose your extra membergroups that can edit this block only. <br><br>Note that "manage_blocks" and "admin" permission always give this right regardless.';
...
$txt['tp-membergrouphelp']='Choose your membergroups that will able to see this block.<br><br> Note that if <b>none</b> are chosen, it will only display it to admin.';
...
$txt['tp-module7'] = 'Articles: recently written';
$txt['tp-module8'] = 'Articles: top views';
$txt['tp-module9'] = 'Articles: top comments';
...
$txt['tp-hidearticle-facebook'] = 'Hide Facebook';
$txt['tp-hidearticle-twitter'] = 'Hide Twitter';
$txt['tp-hidearticle-google'] = 'Hide Google';
$txt['tp-hidearticle-reddit'] = 'Hide Reddit';
$txt['tp-hidearticle-digg'] = 'Hide Digg';
$txt['tp-hidearticle-delicious'] = 'Hide Delicious';
$txt['tp-hidearticle-stumbleupon'] = 'Hide Stumbleupon';
...
$txt['tp-removemenow'] = 'Remove the module?';
$txt['tp-version'] = 'Version';
$txt['tp-tpversion'] = 'TP Version';
$txt['tp-smfversion'] = 'SMF version';
$txt['tp-website'] = 'Website';
$txt['tp-email'] = 'Email';
$txt['tp-subqueryalreadyinstalled'] = 'This module use the same subquery as another module!<br> Please remove the other one before attempting to install.';
...
// Downloads Manager
$txt['tp-module1'] = 'Downloads: Show x New Files';
$txt['tp-module2'] = 'Downloads: Top x Downloads';
$txt['tp-module3'] = 'Downloads: Top x Views';
$txt['tp-module4'] = 'Downloads: Latest File Uploaded';
$txt['tp-module5'] = 'Downloads: Top File in Downloads';
$txt['tp-module6'] = 'Downloads: Top File in Views';
...
$txt['tp-latestblocks'] = 'Latest Blockcodes';
...
$txt['tp-frontpagetitle'] = 'Use a custom frontpage title: ';
